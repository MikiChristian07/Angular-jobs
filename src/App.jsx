...
const App = () => {
  return (
    <>
      ...
      {/* Hero */}
      <section class="bg-red-700 py-20 mb-4">
        <div
        ...
        <div class="container-xl lg:container m-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg">
            <div class="bg-gray-100 p-6 rounded-lg shadow-md">
              ...
              <p class="mt-2 mb-4">
                Browse our Angular jobs and start your career today
              </p>
              <a
                href="/jobs.html"
            ...
            <div class="bg-indigo-100 p-6 rounded-lg shadow-md">
              ...
              <a
                href="/add-job.html"
                class="inline-block bg-red-500 text-white rounded-lg px-4 py-2 hover:bg-red-600"
              >
                Add Job
              </a>
            </div>
          ...
          {/* Job Listing 1 */}
            <div class="bg-white rounded-xl shadow-md relative">
              <div class="p-4">
                <div class="mb-6">
                  ...
                  <h3 class="text-xl font-bold">Senior Angular Developer</h3>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md relative">
              <div class="p-4">
                ...
                <h3 class="text-red-500 mb-2">$70K - $80K / Year</h3>
            ...
            <div class="bg-white rounded-xl shadow-md relative">
              <div class="p-4">
                <div class="mb-6">
                  <div class="text-gray-600 my-2">Remote</div>
                  <h3 class="text-xl font-bold">Angujar Developer</h3>
                </div>
